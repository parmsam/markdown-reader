    ...
    <div className="flex flex-col h-screen overflow-hidden" style={{ background: "var(--bg)" }}>
      ...
      >
        ...
        <div className="flex items-center gap-2.5 mr-1">
          <BookIcon />
          <span
            className="font-semibold text-sm truncate max-w-64"
...
function IconBtn({
  ...
  return (
    <button
      ...
      onMouseLeave={(e) => {
        (e.currentTarget as HTMLElement).style.background = active ? "var(--accent-bg)" : "transparent";
      }}
    >
      {children}
    </button>
